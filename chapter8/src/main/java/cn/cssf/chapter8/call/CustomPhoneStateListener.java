    ...
    public void onCallStateChanged(int state, String incomingNumber) {
        ...
        switch (state) {
            case TelephonyManager.CALL_STATE_IDLE:      // 电话挂断
                Log.d(PhoneListenService.TAG, "CustomPhoneStateListener onCallStateChanged 电话挂断");
                break;
            case TelephonyManager.CALL_STATE_RINGING:   // 电话响铃
                Log.d(PhoneListenService.TAG, "CustomPhoneStateListener onCallStateChanged 电话响铃");
                HangUpTelephonyUtil.endCall(mContext);
                break;
            case TelephonyManager.CALL_STATE_OFFHOOK:    // 来电接通 或者 去电，去电接通  但是没法区分
                Log.d(PhoneListenService.TAG, "CustomPhoneStateListener onCallStateChanged 电话接通");
                break;
        }
    }
}
